...
public class MainActivity extends AppCompatActivity {
    ...
    Button searchRoute,searchBus,trackBus,notice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notice = (Button) findViewById(R.id.pdf);
        ...
        notice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PdfArchive.department = "CSE";
                Intent noticeBoardIntent = new Intent(MainActivity.this,PdfArchive.class);
    ...
    void trackSelectedBus(){
        ...
        Intent intent = new Intent(MainActivity.this, BusTrackFinal.class);
        startActivity(intent);
    }
}